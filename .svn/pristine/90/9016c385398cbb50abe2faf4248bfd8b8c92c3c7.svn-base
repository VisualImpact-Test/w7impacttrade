    ...
    <table class="table table-striped table-bordered nowrap" width="100%">
        <thead>
            <tr>
                ...
                <th class="text-center">GRUPO MODULO</th>
        ...
        <tbody>
            ...
            ?>
                <tr data-id="<?= $value['idModulo'] ?>" data-estado="<?= $value['estado'] ?>">
                    <td></td>
                    <td></td>
                    <td>
                        <div>
                    ...
                    <td><?= verificarEmpty($value['moduloGrupo'], 3) ?></td>
                    <td><?= verificarEmpty($value['modulo'], 3) ?></td>
                    <td><?= verificarEmpty($value['orden'], 3) ?></td>

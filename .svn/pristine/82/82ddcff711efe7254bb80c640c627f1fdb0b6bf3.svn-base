            ...
            <div class="card-body p-0">
                <ul class="nav nav-tabs nav-justified">
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-0" class="nav-link active" data-value="1">Distribuidora</a>
                    </li>
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-1" class="nav-link" data-value="2">Distribuidora Sucursal</a>
                    </li>
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-2" class="nav-link" data-value="3">Zona</a>
                    </li>
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-3" class="nav-link" data-value="4">Plaza</a>
                    </li>
                </ul>
            </div>
        </div>

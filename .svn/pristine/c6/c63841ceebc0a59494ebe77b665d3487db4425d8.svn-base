                <div class="card-datatable">
                    <table class="table table-striped table-bordered nowrap w-100 text-nowrap">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr data-id="<?= $value[$this->model->tablas['listaPrecio']['id']] ?>" data-estado="<?= $value['estado'] ?>">
                                    <td></td>
                                    <td></td>
                                    <td>
                                        <div>
                                    ...
                                    <td><?= !empty($value['valorMin']) ? $value['valorMin'].' %' : '-' ?></td>
                                    <td><?= !empty($value['valorMax']) ? $value['valorMax'].' %' : '-' ?></td>

                    ...
                    <table class="mb-0 table table-bordered text-nowrap w-100 ">
                        <thead class=""> 
                            <tr>
                                ...
                                <th class="text-center excel-borrar noVis">#</th>
                                ...
                                <th class="text-center">PROMEDIO AUDITORIA</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr data-fechaModificacion="<?= !empty($value['fechaModificacion']) ? date_change_format($value['fechaModificacion']) : '-'?>" data-id="<?= $value[$this->model->tablas['confPlaza']['id']] ?>" data-estado="<?= $value['estado'] ?>" data-usuario ="<?= !empty($value['usuario']) ? $value['usuario'] : '-' ?>"  data-fechaReg =" <?=  date_change_format($value['fechaReg'] )?>"  data-horaReg =" <?=  $value['horaReg'] ?>">
                                    <td class="excel-borrar"></td>
                                    <td></td>
                                    <td>
                                        <div>
                                    ...
                                    <td><?= !empty($value['tipoAuditoriaExt']) ? $value['tipoAuditoriaExt'] : '-' ?></td>
                                    <td><?= !empty($value['extAudPromedio']) ? $value['extAudPromedio'] : '-' ?></td>

    ...
    <div class="col-12">
        ...
        <div class="mb-3 card">
            <div class="card-header-tab card-header">
                <ul class="nav">
                    <li class="nav-item"><a data-toggle="tab" href="#tab-content-0" class="active nav-link">Tipo Información</a></li>
                    <li class="nav-item"><a data-toggle="tab" href="#tab-content-1" class="nav-link">Tienda</a></li>
                </ul>
                <div class="funciones">
	...
	<div class="col-lg-12">
		<div class="main-card mb-3 card">
			<div class="card-header">
				<i class="fas fa-list-alt fa-lg"></i>&nbspTipo información
			</div>
...
<div class="row contentGestion contentLista" style="display: none;">
	<div class="col-lg-12">
		<div class="main-card mb-3 card">
			<div class="card-header">
				<i class="fas fa-list-alt fa-lg"></i>&nbspTienda
			</div>

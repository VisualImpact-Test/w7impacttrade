...
class Obligatoria extends MY_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('configuraciones/gestion/visibilidad/m_obligatoria', 'model');
        ...
        $this->carpetaHtml = 'modulos/configuraciones/gestion/visibilidad/vistas_generales/';
	...
	public function index()
	{
		...
		$config['js']['script'] = [
			...
			'assets/custom/js/configuraciones/gestion/visibilidad/obligatoria'
		];

		$config['nav']['menu_active'] = '89';
		$config['data']['icon'] = 'fas fa-share-alt';
		$config['data']['title'] = 'Visibilidad Obligatoria';
		$config['data']['message'] = 'Gestión';
		$config['view'] = 'modulos/configuraciones/gestion/visibilidad/obligatoria/index';
	...
	public function nuevoElementoMasivo(){
		...
		$html .= $this->load->view("modulos/configuraciones/gestion/visibilidad/obligatoria/elementosNuevoMasivo", $array, true);

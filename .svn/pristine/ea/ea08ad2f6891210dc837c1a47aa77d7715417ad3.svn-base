                            ...
                            <td class="text-center" >
                                <select class='form-control form-control-sm iniciativas' name="<?=$nameSelectIniciativa?>">
                                    ...
                                    <?php foreach ($iniciativas as $id => $iniciativa) { ?>
                                        <option value='<?= $iniciativa[$this->model->tablas['elemento']['id']] ?>'><?= $iniciativa['nombre'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
...
<script>
    ...
    IniciativaTrad.elementos=<?=json_encode($elementos)?> 
    IniciativaTrad.grupoCanal=<?=json_encode($grupoCanal_canales)?> 

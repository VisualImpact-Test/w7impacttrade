...
<form id="formUpdate">
    ...
    <div class='form-row'>
        ...
        <div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-2 d-none'>
            ...
            <div class="proyecto_sl">
                ...
                <label for='cadena'>Cadena</label><br>
                    <select id='cadena' name='cadena' class='form-control form-control-sm my_select2'>
                     <option value=''>-- Seleccionar --</option>

                    <?php if (!empty($data['idCadena'])) { ?>
                        <option value='<?= $data['idCadena'] ?>' selected><?= $data['cadena'] ?></option>
                    <?php } ?>
                    <?php foreach ($cadenas as $idCadena => $cadena) { ?>
                        <?php if ($data['idCadena'] != $cadena['idCadena']) { ?>
                            <option value='<?= $cadena['idCadena'] ?>'><?= $cadena['nombre'] ?></option>
                        <?php } ?>
                    <?php } ?>
                    </select>
                </div>
        <div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-2'>
            ...
            <select id='banner' name='banner' class='form-control form-control-sm my_select2'>
                <option value=''>-- Seleccionar --</option>

                    <?php if (!empty($data['idBanner'])) { ?>
                        <option value='<?= $data['idBanner'] ?>' selected><?= $data['banner'] ?></option>
                    <?php } ?>
                <?php foreach ($banners as $idBanner => $banner) { ?>
                    <?php if ($data['idBanner'] != $banner['idBanner']) { ?>
                    <option value='<?= $banner['idBanner'] ?>'><?= $banner['nombre'] ?></option>
                    <?php } ?>

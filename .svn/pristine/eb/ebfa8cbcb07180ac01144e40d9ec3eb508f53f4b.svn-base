...
<div class="col-12">
		...
		<div class="col-9">
			<select name="clientetipo" id="clientetipo" class="form-control text-center" style="width: 100%;">
				<? foreach($modulos as $row){ ?>
					<option value="<?=$row['idSubCanal']?>"><?=$row['nombre']?></option>
				<? } ?>
			</select>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-9">
			<input name="mincategoria" id="mincategoria" value="" type="text" class="form-control  text-center" style="width: 100%;">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-9">
			<input name="minelementos" id="minelementos" value="" type="text" class="form-control  text-center" style="width: 100%;">
		</div>
	</div>

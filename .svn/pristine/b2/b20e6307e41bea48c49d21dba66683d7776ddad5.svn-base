...
<div id="map_canvas" class="dv-maps" style="height: 500px;"></div>
<script type="text/javascript">
lat = <?php echo $latitud; ?>;
lng = <?php echo $longitud; ?>;

lat_cliente = <?=empty($latitud_cliente)? 0 : $latitud_cliente; ?>;
lng_cliente = <?=empty($longitud_cliente)? 0 : $longitud_cliente; ?>;

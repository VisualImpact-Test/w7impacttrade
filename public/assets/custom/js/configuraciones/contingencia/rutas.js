var ContingenciaRutas = {
	...
	load: function(){
		...
		$(document).on("click",".card-body > ul > li > a", function (e) {
			ContingenciaRutas.contentDetalle = $(this).attr('href').split('#')[1];
			$("input[name=tipoFormato]").val($(this).data('value'));
		});
		...
		$(document).on('click','.incidenciaVisita', function(){
			...
			$.when( Fn.ajax(configAjax)).then( function(a){
				...
				fn[0] = 'Fn.showModal({ id:'+modalId+',show:false });ContingenciaRutas.verificarIncidenciaEstado('+JSON.stringify(data)+')';
		...
		$(document).on('click','.btn-file', function(e){
			...
			$(this).parents(".divContentImg").find(".btnAbrirFoto").removeClass('disabled');
			$('#'+file).click();
		});

		$(document).on('click','.btnAbrirFoto', function(e){
			e.preventDefault();
			$(this).parents(".divContentImg").find(".fotoMiniatura").click();
		});
        	...
        	var fila = '';
        		fila+='<tr class="tr-promociones-ad tr-promociones-adicionales" data-visitaPromociones="0" data-visitaPromocionesDet="'+prefijo+'" data-promocion="0">';
        			fila+='<td class="text-center">';
        				fila+='<button type="button" class="btn-deleteRowPromociones btn btn-outline-danger border-0" ><i class="fas fa-trash fa-lg"></i></button>';
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<select class="form-control form-control-sm slWidth" name="tipoPromocion-'+prefijo+'" id="tipoPromocion-'+prefijo+'" style="width:92%">';
        			...
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<input class="form-control form-control-sm ipWidth" type="text" placeholder="Nombre Promoción" id="nombrePromocion-'+prefijo+'"  name="nombrePromocion-'+prefijo+'" value="" style="width:97%">';
        			fila+='</td>';
        			fila+='<td class="text-center">';
        			...
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<div id="foto-'+prefijo+'" style="display:inline-flex;" class="divContentImg">';
							fila+='<div>';
								fila+='<a href="javascript:;" class="lk-foto-1" data-content="img-fotoprincipal-'+prefijo+'">';
									fila+='<img class="fotoMiniatura foto" name="img-fotoprincipal-'+prefijo+'" id="img-fotoprincipal-'+prefijo+'" src="" alt="" style="width: 40px;display: none;">';
								fila+='</a>';
							fila+='</div>';
							fila+='<div>';
								fila+='<span class="btn border-0 btn-outline-secondary btn-file btnAbrirFoto disabled" title="Abrir imagen subida"><i class="fal fa-image-polaroid fa-lg" aria-hidden="true"></i></span>';
							fila+='</div>';
							fila+='<div>';
								fila+='<div class="content-input-file">';
									...
									fila+='<input type="text" readonly="readonly" id="txt-fotoprincipal-'+prefijo+'_show" class="text-file hide" placeholder="Solo .jpg" >';
									fila+='<span class="btn border-0 btn-outline-secondary btn-file btnFoto" data-file="fl-fotoprincipal-'+prefijo+'" title="Subir imagen JPG"><i class="fa fa-file-upload fa-lg" aria-hidden="true"></i></span>';
        ...
        $(document).on('click','.btn-deleteRowModuloFoto',function(e){
        	...
        	++modalId;
			fn[0] = 'Fn.showModal({ id:'+modalId+',show:false });';
			fn[1] = 'ContingenciaRutas.guardarFotoEstado('+visitaModuloFoto+');Fn.showModal({ id:'+modalId+',show:false });';
        ...
        $(document).on('click','#btn-addRowFoto', function(e){
        	...
        	var fila = '';
        		fila+='<tr class="tr-moduloFoto tr-moduloFoto-adicionales" data-visitaModuloFoto="'+prefijo+'" >';
        			...
        			fila+='<td class="text-center">';
        				fila+='<select class="form-control form-control-sm slWidth" name="tipoFoto-'+prefijo+'" id="tipoFoto-'+prefijo+'" style="width:100%">';
        			...
        			fila+='<td class="text-center">';
        				fila+='<div id="foto-'+prefijo+'" style="display:inline-flex;" class="divContentImg">';
							fila+='<div>';
								fila+='<a href="javascript:;" class="lk-foto-1" data-content="img-fotoprincipal-'+prefijo+'">';
									fila+='<img class="fotoMiniatura imgNormal foto" name="img-fotoprincipal-'+prefijo+'" id="img-fotoprincipal-'+prefijo+'" src="" alt="" style="width: 40px;display: none;">';
								fila+='</a>';
							fila+='</div>';
							fila+='<div>';
								fila+='<span class="btn border-0 btn-outline-secondary btn-file btnAbrirFoto disabled" title="Abrir imagen subida"><i class="fal fa-image-polaroid fa-lg" aria-hidden="true"></i></span>';
        			...
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<input class="form-control form-control-sm ipWidth" type="text" placeholder="Comentario" id="comentario-'+prefijo+'"  name="comentario-'+prefijo+'" value="" style="width:100%">';
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<button type="button" class="btn btn-outline-danger border-0 btn-deleteRowFotosAdicionales" ><i class="fas fa-trash fa-lg"></i></button>';
        			fila+='</td>';
        		fila+='</tr>';
        	...
        	var fila='';
        		fila+='<tr class="tr-visibilidadTrad tr-visibilidadTrad-adicionales" data-visitaVisibilidad="0" data-visitaVisibilidadDet="'+prefijo+'">';
        			...
        			fila+='<td class="text-center">';
						...
						fila+='<label>NO MODULADOS</label>'
						fila+='<input type="hidden" value="1"/>'
        			fila+='</td>';
        			fila+='<td class="text-center">';
						fila+='<div class="custom-checkbox custom-control">';
							fila+='<input class="custom-control-input" type="checkbox" id="presencia-'+prefijo+'"  name="presencia-'+prefijo+'" value="1" >';
        ...
        $(document).on('click','#btn-addRowInteligencia', function(e){
        	...
        	var fila='';
        		fila+='<tr class="tr-competencias tr-competencias-adicionales" data-visitaInteligencia="0" data-visitaInteligenciaCompetitiva="'+prefijo+'">';
        			fila+='<td class="text-center">';
        				fila+='<button type="button" class="btn btn-outline-danger border-0 btn-deleteRowCompetencias" ><i class="fas fa-trash fa-lg"></i></button>';
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<select class="form-control slWidth categoriaCompetencias" name="categoria-'+prefijo+'" id="categoria-'+prefijo+'" data-prefijo="'+prefijo+'" style="width: 100%;">';
        			...
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<select class="form-control slWidth marcaCompetencias" name="marca-'+prefijo+'" id="marca-'+prefijo+'" style="width: 100%;">';
        					fila+='<option value="">-- Lista Marcas --</option>';
        				fila+='</select>';
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<select class="form-control slWidth" name="competencia-'+prefijo+'" id="competencia-'+prefijo+'" style="width: 100%;">';
        			...
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<input type="text" class="form-control ipWidth" placeholder="Comentario" id="comentario-'+prefijo+'"  name="comentario-'+prefijo+'" value="" style="width: 100%;">';
        			fila+='</td>';
        			fila+='<td class="text-center">';
        				fila+='<div id="foto-'+prefijo+'" style="display:inline-flex;" class="divContentImg">';
							fila+='<div>';
		...
		$(document).on('click','.opcionCargarData', function(){
			...
			$.when( Fn.ajax(configAjax)).then( function(a){
				...
				fn[0] = 'Fn.showModal({ id:'+modalId+',show:false });';
				fn[1] = 'ContingenciaRutas.guardarCargaData('+modalId+');';
	...
	verificarFormulario: function( idForm, funcion){
		...
		$.when( Fn.validateForm({ 'id':idFrm }) ).then( function(a){
			...
			if ( !a ) {
				...
				++modalId;
				fn[1]='ContingenciaRutas.'+funcionGuardar+'();Fn.showModal({ id:'+modalId+',show:false });';
				fn[0]='Fn.showModal({ id:'+modalId+',show:false });';
				btn[0]={title:'Cerrar',fn:fn[0]};
	...
	guardarFotos: function(){
		...
		$('.tr-moduloFoto-adicionales').each( function(ix,val){
			...
			comentario = tr.find('#comentario-'+visitaModuloFoto).val();

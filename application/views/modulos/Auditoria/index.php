			...
			<div class="customizer-content-filter">
				...
				<div class="form-row">
					...
					<div class="col-md-12">
						...
						<div class="mb-2 mr-sm-2 position-relative form-group custom_tooltip dv_tipoCliente">
							<span class="tooltiptext">Tipo Cliente</span>
							<?= getFiltros(['tipoCliente' => ['label' => 'Tipo Cliente', 'name' => 'sl_tipo_cliente', 'id' => 'sl_tipo_cliente', 'data' => false, 'select2' => 'ui my_select2Full', 'html' => '']]) ?>
						</div>

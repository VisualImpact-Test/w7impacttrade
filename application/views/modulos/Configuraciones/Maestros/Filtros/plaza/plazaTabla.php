    ...
    <table class="table table-striped table-bordered nowrap" width="100%">
        <thead>
            <tr>
                ...
                <th class="text-center">COD UBIGEO</th>
                <th class="text-center">NOMBRE MAYORISTA</th>
        ...
        <tbody>
            ...
            ?>
                <tr data-id="<?= $value['idPlaza'] ?>" data-estado="<?= $value['estado'] ?>">
                    <td></td>
                    <td></td>
                    <td>
                        <div>
                    ...
                    <td class="text-center"><?= !empty($value['cod_ubigeo']) ? $value['cod_ubigeo'] : '-' ?></td>
                    <td><?= !empty($value['nombreMayorista']) ? $value['nombreMayorista'] : '-' ?></td>

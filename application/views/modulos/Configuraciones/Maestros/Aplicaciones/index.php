            ...
            <div class="card-body p-0">
                <ul class="nav nav-tabs nav-justified">
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-0" class="nav-link active" data-value="1">Gestor Aplicaciones</a>
                    </li>
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-1" class="nav-link" data-value="1">Modulos Grupo</a>
                    </li>
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-2" class="nav-link" data-value="1">Modulos</a>
                    </li>

                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-3" class="nav-link" data-value="1">Menu</a>
                    </li>
                    <li class="nav-item btnReporte" name="tipoReporte">
                        <a data-toggle="tab" href="#tab-content-4" class="nav-link" data-value="1">Menu Cuenta</a>
                    </li>
                </ul>
            </div>
        </div>

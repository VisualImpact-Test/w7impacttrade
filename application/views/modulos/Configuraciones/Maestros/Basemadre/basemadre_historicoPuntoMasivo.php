			...
			<div class="card-body">
				<div class="col-md-4 col-sm-4 col-xs-4" >
					<div class="position-relative form-check form-check-inline">
						<label class="form-check-label">
							<input type="radio" name="registrar" value="0" class="form-check-input" checked> Actualizar Historico</label>
					</div>
					<div class="position-relative form-check form-check-inline">
						<label class="form-check-label">
							<input type="radio" name="registrar" value="1" class="form-check-input"> Nuevo Historico</label>
					</div>
				</div>
				<br>
				<div class="">
				...
				<div class="tab-content">
					<div class="table-responsive"><!-- style="width: 100%;"-->
						<div id="historicoPuntoMasivo"></div><!--style="overflow: auto;"-->
					</div>
				</div>
				<div class="hide">

...
<form id="actualizar_ruta">
	...
	<div class="row">
		...
		<!--<div class="col-md-4 col-sm-4 col-xs-4" >
			...
			<input type="text" class="form-control input-sm " readonly name="fecha_fin" value="<?= isset($data[0]['generado']) ?  (($data[0]['generado'] == "1") ? "Si" : "No") :  'No'; ?>">
		</div>-->
	</div>

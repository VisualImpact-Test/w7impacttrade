    ...
    <div class="col-12">
        ...
        <div class="mb-3 card">
            <div class="card-header-tab card-header">
                <ul class="nav">
                    <li class="nav-item"><a data-toggle="tab" href="#tab-content-0" class="active nav-link">Elemento</a></li>
                    <li class="nav-item"><a data-toggle="tab" href="#tab-content-1" class="nav-link">Lista Elemento Visibilidad Iniciativa</a></li>
                </ul>
                <div class="funciones">
                    ...
                    <button class="btn btn-outline-primary border-0 btn-CargaMasiva-elemento" title="Carga Masiva Elemento"><i class="fas fa-folder-plus"></i></button>
                    ...
                    <div class="tab-pane fade" id="tab-content-1" role="tabpanel">
                        ...
                        <div class="form-row mb-3">
                                ...
                                <div class="col-auto">
                                    ...
                                    <?= getFiltros(['cuenta' => ['label' => 'Cuenta', 'name' => 'cuenta', 'id' => 'cuenta_filtro', 'data' => true, 'select2' => 'my_select2Full', 'html' => '']]) ?>
                                </div>
...
<div class="row contentGestion contentLista" style="display: none;">
	<div class="col-lg-12">
		<div class="main-card mb-3 card">
			<div class="card-header">
				<i class="fas fa-list-alt fa-lg"></i>&nbspLista
			</div>

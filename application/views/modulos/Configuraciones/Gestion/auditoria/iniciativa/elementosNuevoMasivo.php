			...
			<div class="card-body">
				<div class="div-informacion">
					<div class="alert alert-warning" role="alert">
						...
						<i class="fas fa-check-circle"></i> La carga masiva tiene un tope <strong>máximo de 250 filas</strong>, si usted dispone de más datos, se recomienda realizar el procedimiento dos veces.<br>
					</div>
				</div>
				<div class="tab-content">
					<div class="table-responsive"><!-- style="width: 100%;"-->
						<div id="nuevoElementoMasivo"></div><!--style="overflow: auto;"-->
					</div>
				</div>
			</div>
		</div>
...
<script>
	Iniciativa.dataListaCategoriaNombre = JSON.parse('<?=json_encode($listaCategoriasNombre)?>');
	Iniciativa.dataListaProyectoNombre = JSON.parse('<?=json_encode($listaProyectosNombre)?>');
</script>
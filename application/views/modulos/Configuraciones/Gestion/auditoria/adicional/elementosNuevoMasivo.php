...
<script>
	Adicional.dataListaCategoriaNombre = JSON.parse('<?=json_encode($listaCategoriasNombre)?>');
	Adicional.dataListaProyectoNombre = JSON.parse('<?=json_encode($listaProyectosNombre)?>');
</script>
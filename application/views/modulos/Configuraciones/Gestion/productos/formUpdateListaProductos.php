...
$select2 = "my_select2ModalAgregarLista"; 
$class = "modalUpdate";
?>
<style>
...
<form id="formUpdate">
    ...
    <div class='form-row'>
        <div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-2'>
            ...
            <select id='grupoCanal' name='grupoCanal' class='form-control form-control-sm my_select2Modal grupoCanal_sl'>
        ...
        <div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-2'>
            <label for='canal'>Canal</label><br>
                <select id='canal' name='canal' class='form-control form-control-sm my_select2Modal canal_sl canal_cliente'>
                <option value=''>-- Seleccionar --</option>
    ...
    <div class='form-row'>
        ...
        <label for='cliente'>Cliente</label><br>
            <div class="cliente_sl">
                <select id='cliente' name='cliente' class='form-control form-control-sm my_select2Modal'>
                    <option value=''>-- Seleccionar --</option>

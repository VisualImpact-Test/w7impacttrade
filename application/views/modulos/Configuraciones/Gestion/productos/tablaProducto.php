                        ...
                        <tbody>
                            ...
                            ?>
                                <tr data-id="<?= $value[$this->model->tablas['elemento']['id']] ?>" data-estado="<?= $value['estado'] ?>">
                                    ...
                                    <td><?= !empty($value['marca']) ? $value['marca'] : '-' ?></td>
                                    ...
                                    <td><?= !empty($value['ean']) ? $value['ean'] : '-' ?></td>
                                    <td><?= !empty($value['flagCompetencia']) ? 'SI' : 'NO' ?></td>
                                    <td><?= !empty($value['envase']) ? $value['envase'] : '-' ?></td>

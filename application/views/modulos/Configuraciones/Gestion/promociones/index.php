        ...
        <div class="card w-100 mb-3 p-0">
            <div class="card-body p-0">
                <ul class="nav nav-tabs nav-justified">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#tab-content-0">Promociones</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-content-1">Lista Promociones </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-content-2">Tipo Promoción </a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-2 mr-sm-2 position-relative form-group dv_canal">
                            <?= getFiltros(['canal' => ['label' => 'Canal', 'name' => 'sl_canal', 'id' => 'canal', 'data' => true, 'select2' => 'my_select2Full ', 'html' => '']]) ?>
                        </div>
                        <div class="mb-2 mr-sm-2 position-relative form-group dv_cadena">
                            <?= getFiltros(['cadena' => ['label' => 'Cadena', 'name' => 'sl_cadena', 'id' => 'cadena', 'data' => true, 'select2' => 'my_select2Full ', 'html' => '']]) ?>
                        </div>
                    </div>
                </div>
            </div>

<form id="formCargaMasiva" role="form">
    <div class="row">
        <div class="col-md-12" id="divTablaCargaMasiva">
            <input type="hidden" name="idProyecto" value="<?=$data['idProyecto']?>">
            <input type="hidden" name="idEncuesta" value="<?=$data['idEncuesta']?>">
            <input type="hidden" name="idPregunta" value="<?=$data['idPregunta']?>">

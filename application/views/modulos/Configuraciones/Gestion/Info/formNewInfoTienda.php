                    ...
                    <tbody>
                        ...
                        foreach ($lista_elementos as $key => $row) { ?>
                            <tr class='trHijo table-secondary' data-fila="<?=$num?>">
                                ...
                                <td class="text-center">
                                    <input  type='text' class='form-control form-control-sm' placeholder='Valor' value="<?= ($row['valor']) ?>">
                                </td>
                                <td class="text-center">
                                    <input  type='date' class='form-control form-control-sm' placeholder='Fecha' value="<?= ($row['fecIni']) ?>">
                                </td>
                                <td class="text-left" >

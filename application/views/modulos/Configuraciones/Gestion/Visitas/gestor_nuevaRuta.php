			...
			<div class="card w-100 mb-3 p-0">
				<div class="card-body p-0">
					<ul class="nav nav-tabs nav-justified">
						<li class="nav-item"><a data-toggle="tab" href="#tab-datosRuta" class="nav-link active">REGISTRAR RUTA</a></li>
						...
						<div class="form-row">
							...
							<div class="col-md-4">
								<div class="position-relative form-group">
									...
									<select class="form-control slWidth my-select2-modal" id="cuenta" name="cuenta" patron="requerido">
							...
							<div class="col-md-4">
								<div class="position-relative form-group">
									...
									<select class="form-control slWidth my-select2-modal" id="proyecto" name="proyecto" patron="requerido">
						...
						<div class="form-row">
							<div class="col-md-4">
								<div class="position-relative form-group">
									...
									<select class="form-control slWidth my-select2-modal" id="tipoUsuario" name="tipoUsuario">
							...
							<div class="col-md-4">
								<div class="position-relative form-group">
									...
									<select class="form-control slWidth my-select2-modal usuarioModal" id="usuario" name="usuario" patron="requerido">
						...
						<div class="form-row">
							<div class="col-md-4">
								<div class="position-relative form-group">
									...
									<select class="form-control slWidth my-select2-modal" id="grupoCanal" name="grupoCanal">
							...
							<div class="col-md-4">
								<div class="position-relative form-group">
									...
									<select class="form-control slWidth my-select2-modal" id="canal" name="canal" patron="requerido">
							...
							<div class="col-md-12">
								<div class="position-relative form-group">
									...
									<div class="input-group">
										<select class="form-control my-select2-modal-clientes" id="cliente" name="cliente">
...
<script>
	...
	$('.my-select2-modal').select2({
		dropdownParent: $("#frm-gestorNuevaRuta"),
		width: '100%'
	});

	$('.my-select2-modal-clientes').select2({

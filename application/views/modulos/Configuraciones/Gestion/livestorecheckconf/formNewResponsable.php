<form id="formNew">
    ...
    <input type="hidden" name="sl_proyecto" id="sl_proyecto" value="3">
        ...
        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2'>
            ...
            <input id='nombres' name='nombres' type='text' class='form-control form-control-sm' placeholder='Nombres'>
        </div>
        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2'>
            <label for='apellidos'>Apellidos</label><br>
            <input id='apellidos' name='apellidos' type='text' class='form-control form-control-sm' placeholder='Apellidos'>
        </div>
    </div>

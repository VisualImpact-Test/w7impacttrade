<form id="formUpdate">
    <div class='form-row'>
    <input class="d-none" type="text" name="idx" value="<?= $data[$this->model->tablas['confPlaza']['id']] ?>">
    <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2'>
        ...
        <div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-2'>
            ...
            <input value="<?=!empty($data['extAudPromedio'])? $data['extAudPromedio']: ''?>" id='audPromedio' name='audPromedio' type='text' class=' txt-only-number form-control form-control-sm' placeholder='Promedio'>
        </div>
        <div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-2'>

		...
		<div class="card w-100 mb-3 p-0">
			<div class="card-body p-0">
				<ul class="nav nav-tabs nav-justified">
					...
					<li class="nav-item "><a data-toggle="tab" href="#contentListaModulacion" class="nav-link" data-value="2"> Listas de Elementos de Modulación</a></li>
					<li class="nav-item "><a data-toggle="tab" href="#contentLista" class="nav-link" data-value="1"> Listas de Elementos Obligatoria</a></li>
				</ul>
			</div>
		</div>
	</div>

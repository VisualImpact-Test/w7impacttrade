...
<div class="card-datatable">
	<table id="tb-premiaciones" class="mb-0 table table-bordered text-nowrap" width="100%">
		...
		<tbody>
			...
			?>
				<tr>
					<td class="text-center" style="text-align:center;"><?= $ix; ?></td>
					<td class="text-center" style="text-align:center;"><?= verificarEmpty($row['fecha'], 3); ?></td>
					<td class="text-center" style="text-align:center;"><?= verificarEmpty($row['hora'], 3); ?></td>
					...
					<td class="text-left" style="text-align:center;"><?= $row['tipoPremiacion']; ?></td>
					<td class="text-center" style="text-align:center;"><?= $row['codigo']; ?></td>

				...
				<ul class="nav nav-tabs nav-justified">
					<? foreach ($tabs as $k => $v) { ?>
						<li class="nav-item btnReporte">
							<a data-toggle="tab" href="#<?= $v['contenedor'] ?>" class="<?= ($v['orden'] == 1) ? 'active' : '' ?> nav-link" data-url="<?= $v['url'] ?>"><?= $v['nombre'] ?></a>
						</li>
					<? } ?>
				</ul>
			</div>
	...
	<div class="customizer-content p-2 ps-container ps-theme-dark" data-ps-id="aca1f25c-4ed9-a04b-d154-95a5d6494748">
		<form id="frm-promociones">
			...
			<div class="customizer-content-button">
				...
				<button type="button" class="btn btn-outline-trade-visual border-0 " data-url="filtrar" id="btn-promociones-pdf" title="Exportar PDF">
			...
			<div class="customizer-content-filter">
				...
				<div class="form-row">
					<div class="col-md-12">
						...
						<div class="filtros_aje" style="display: none;">
							<div class="filtros_aje_resumido" style="display: none;">
								<div class="mb-2 mr-sm-2 position-relative form-group filtros_asistencia custom_tooltip">
									<span class="tooltiptext">Mes</span>
									<select class="form-control form-control-sm ui my_select2Full" name="mes_filtro" id="mes_filtro" patron="requerido">
										<?= htmlSelectOptionArray2(['simple' => 1, 'query' => $meses, 'id' => 'idMes', 'value' => 'mes', 'selected' => date('m')]) ?>
									</select>
								</div>
								<div class="mb-2 mr-sm-2 position-relative form-group filtros_asistencia custom_tooltip">
									<span class="tooltiptext">Año</span>
									<select class="form-control form-control-sm ui my_select2Full" name="anio_filtro" id="anio_filtro" patron="requerido">
										<?= htmlSelectOptionArray2(['simple' => 1, 'query' => $anios, 'id' => 'idAnio', 'value' => 'anio', 'selected' => date('Y')]) ?>
									</select>
								</div>
								<div class="mb-2 mr-sm-2 position-relative form-group filtros_asistencia custom_tooltip">

			...
			<div class="card-body p-0">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item btnReporte" id="tipoReporte" name="tipoReporte">
						<a data-toggle="tab" href="#idContentTareas" class="active nav-link" data-value="1" data-contentdetalle="idContentTareas"  data-url="filtrar">Detallado</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="main-card mb-3 card ">
	<div class="card-body p-0">
		<div class="tab-content" id="content-auditoria">
			<div class="tab-pane fade show active" id="idContentTareas" role="tabpanel">

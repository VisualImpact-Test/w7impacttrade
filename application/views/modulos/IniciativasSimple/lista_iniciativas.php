			...
			?>
				<tr>
					...
					if ($row['validacion_analista'] == 1) {
						$edicion = '<span id="spanValidacion-' . $row['idVisitaIniciativaTradDet'] . '">HABILITADO</span>';
					} else {
						$edicion = '<span id="spanValidacion-' . $row['idVisitaIniciativaTradDet'] . '">INHABILITADO</span>';
					}
					?>

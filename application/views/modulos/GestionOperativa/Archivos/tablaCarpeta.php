<div class="card-datatable">
    <table class="table table-striped table-bordered nowrap w-100 text-nowrap">
        ...
        <tbody>
            ...
            ?>
                <tr data-id="<?= $value['idCarpeta'] ?>" data-estado="<?= $value['estado'] ?>">
                    <td></td>
                    <td></td>
                    <td>
                        <div>
                    ...
                    <td><?= !empty($value['nombreCategoria']) ? $value['nombreCategoria'] : '-' ?></td>
                    <td><?= !empty($value['nombreGrupo']) ? $value['nombreGrupo'] : '-' ?></td>
                    <td><?= !empty($value['espacioOcupado']) ? formatBytes($value['espacioOcupado']) : '-' ?></td>

		...
		<div class="card w-100 mb-3 p-0">
			<div class="card-body p-0">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item btnReporte" id="tipoReporte" name="tipoReporte" data-value="1"><a data-toggle="tab" href="#idDetalleHorizontal" class="active nav-link" data-url="getCantidadFotosPorEncuesta" data-content="idDetalleHorizontal" data-tabla="tablaDetalladoEncuesta">Detallado</a></li>
				</ul>
			</div>
		</div>
	</div>

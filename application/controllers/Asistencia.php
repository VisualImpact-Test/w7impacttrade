			...
			switch ( $data->{'tipoFormato'} ) {
				case 1:
					...
					foreach ($rs_usuarios as $kr => $row) {
						...
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['numDocumento'] = $row['numDocumento'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['usuario'] = $row['usuario'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['tipoUsuario'] = $row['tipoUsuario'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['empresa'] = $row['cuenta'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['departamento'] = $row['departamento'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['provincia'] = $row['provincia'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['distrito'] = $row['distrito'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['grupoCanal'] = $row['grupoCanal'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['canal'] = $row['canal'];
						$array['listaUsuarios'][$row['fecha']]['usuarios'][$row['idEmpleado']]['movil'] = $row['movil'];

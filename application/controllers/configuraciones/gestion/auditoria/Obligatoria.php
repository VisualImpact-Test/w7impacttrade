...
class Obligatoria extends MY_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('configuraciones/gestion/auditoria/m_obligatoria', 'model');
	...
	public function index()
	{
		...
		$config['js']['script'] = [
			...
			'assets/custom/js/configuraciones/gestion/auditoria/obligatoria'
		];
		...
		$config['view'] = 'modulos/configuraciones/gestion/auditoria/obligatoria/index';
	...
	public function nuevoElementoMasivo(){
		...
		$html .= $this->load->view("modulos/configuraciones/gestion/auditoria/obligatoria/elementosNuevoMasivo", $array, true);

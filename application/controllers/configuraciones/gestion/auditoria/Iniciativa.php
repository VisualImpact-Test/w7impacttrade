...
class Iniciativa extends MY_Controller
{
	public function __construct()
	{
		parent::__construct();
		$this->load->model('configuraciones/gestion/auditoria/m_iniciativa', 'model');
		...
		$this->titulo = [
			...
			'actualizarLista' => 'Actualizar Lista Inteligencia Competitiva',
			'registrarLista' => 'Registrar Lista Inteligencia Competitiva',
			'masivoLista' => 'Guardar Masivo Lista Inteligencia Competitiva',

        ];
        
        $this->carpetaHtml = 'modulos/configuraciones/gestion/auditoria/iniciativa/';
	...
	public function index()
	{
		...
		$config['js']['script'] = [
			...
			'assets/custom/js/configuraciones/gestion/auditoria/iniciativa'
		];

		$config['nav']['menu_active']='90';
		$config['data']['icon'] = 'fa fa-eye';
		$config['data']['title'] = 'Visibilidad Auditoria Iniciativa';
		$config['data']['message'] = 'Gestión';
        $config['view'] = 'modulos/configuraciones/gestion/auditoria/iniciativa/index';
	...
	public function nuevoElementoMasivo(){
		...
		$html .= $this->load->view("modulos/configuraciones/gestion/auditoria/Iniciativa/elementosNuevoMasivo", $array, true);
